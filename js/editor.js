...
(function () {
  ...
  var ITEM_CODES = {
    ...
    uni: [
      ...
      ['7wn','Polished Wand (No Unique for this base)'],['7ws','Astreons Iron Ward - Caduceus'],['7xf','Whispering Mirage - War Fist'],['7yw','Nethercrux - Ghost Wand'],['8bs','Warpspear - Gothic Staff'],
      ...
      ['pab','Ephemeral - Sacred Targe'],['pac','Alma Negra - Sacred Rondache'],['pad','Kurast Shield (No Unique for this base)'],['pae','Dragonscale - Zakarum Shield'],['paf','Skywarden - Vortex Shield'],
      ...
      ['tkf','Throwing Knife (No Unique for this base)'],['tow','Bverrit Keep - Tower Shield'],['tri','Razortine - Trident'],['tsp','Throwing Spear (No Unique for this base)'],['uap','Harlequin Crest - Shako'],['uar','Templars Might or Tyraels Might - Sacred Armor'],
      ...
      ['xts','Radaments Sphere - Ancient Shield'],['xtu','Iron Pelt - Trellised Armor'],['xuc','Viscerataunt - Defender'],['xui','The Spirit Shroud - Ghost Armor'],['xul','Black Hades - Chaos Armor'],
    ...
    set: [
      ...
      ['skp','Arcanna\'s Head - Skull Cap'],['sml','Cleglaw\'s Claw - Small Shield'],['spl','Berserker\'s Hauberk - Splint Mail'],['stu','Cow King\'s Hide - Studded Leather'],['swb','Arctic Horn - Short War Bow'],
